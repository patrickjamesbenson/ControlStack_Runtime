...
import { CANONICAL_KEYWORDS, validateKeywordVocabulary } from "../../packages/lab-kernel/ies-toolkit/iesKeywordContract.js";
...
test("active lab form is the exact canonical 16-field profile with sealed-reference internal ambient ownership", () => {
  ...
  assert.deepEqual(validation.actualKeywords, CANONICAL_KEYWORDS);
