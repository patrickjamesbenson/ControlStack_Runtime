...
test("Selector product surface parity lock keeps summary, spine, payload, readiness, and handoffs aligned", () => {
  ...
  const expectedProjectionSummary = {
    ...
    selectedResultAvailable: expectedProjection.selectedResultAvailable,
    sourceState: expectedProjection.sourceState,
    state: expectedProjection.state,
    resultState: expectedProjection.state,
    resultStateLabel: expectedProjection.resultStateLabel,
    accepted: expectedProjection.accepted,
    acceptedSelectedResultAvailable: false,
    engineVerified: expectedProjection.engineVerified,
    stale: expectedProjection.stale,
    summaryProjectionOnly: false,
    selectedFamilySubsetLock: expectedProjection.selectedFamilySubsetLock,
    perRunLookupNormalised: expectedProjection.perRunLookupNormalised,
    oneSuccessfulAcceptedResult: false,
    selectedResultCandidateCount: null,
    sourceInputFingerprint: null,
    boardDataSourceVersion: null,
    selectedResultPersistenceEnabled: expectedProjection.selectedResultPersistenceEnabled,
    runTableGenerationEnabled: expectedProjection.safetyFlags.runTableGenerationEnabled,
    iesGenerationEnabled: expectedProjection.safetyFlags.iesGenerationEnabled,
    outputGenerationEnabled: expectedProjection.safetyFlags.payloadGenerationEnabled,
    routesAdded: expectedProjection.routesAdded,
    postEndpointsAdded: expectedProjection.postEndpointsAdded,
