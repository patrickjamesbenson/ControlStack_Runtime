const moduleStatusItems = [
  ...
  },
  {
    ...
    badge: "planned",
    group: "Knowledge / Governance",
    contract: "placeholder only; formal cockpit contract not accepted yet",
    runtime: "sidebar placeholder only; no mounted module route or automation",
    authority: "none; no automation, records, or governance authority",
    uiEvidence: "planned/disabled sidebar item only",
    nextStep: "define read-only cockpit boundaries before any automation surface",
  },
  {
    ...
    badge: "planned",
    group: "Knowledge / Governance",
    contract: "placeholder only; RREG route/module not mounted yet",
    runtime: "sidebar placeholder only; no mounted module route",
    authority: "none; no role assignment or responsibility authority",
    uiEvidence: "planned/disabled sidebar item only",
    nextStep: "mount read-only RREG diagnostics only after a separate contract",
  },
  {
    id: "engine_flow",
    label: "Engine Flow",
