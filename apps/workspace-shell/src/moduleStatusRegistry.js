const moduleStatusItems = [
  ...
  },
  {
    ...
    badge: "planned",
    group: "Knowledge / Governance",
    contract: "placeholder only; formal read-only shell contract not accepted yet",
    runtime: "sidebar placeholder only; no mounted module route",
    authority: "none; no governed-language or KC/CLX authority",
    uiEvidence: "planned/disabled sidebar item only",
    nextStep: "mount read-only diagnostics only after a separate Canonical Language contract",
  },
  {
    id: "liora_cockpit",
    label: "Liora Cockpit",
