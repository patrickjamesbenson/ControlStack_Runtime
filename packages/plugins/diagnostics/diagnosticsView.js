...
export function renderDiagnosticsView(container, viewModel) {
  ...
  appendSection(article, "Company / CRM context", [
    ...
    ["HubSpot configured", viewModel.crm.hubspotConfigured],
    ["HubSpot read only", viewModel.crm.hubspotReadOnly],
    ["HubSpot reason", viewModel.crm.hubspotReason],
    ["HubSpot auth status", viewModel.crm.hubspotAuthStatus],
    ["HubSpot primary auth", viewModel.crm.hubspotPrimaryAuthMode],
    ["HubSpot active auth", viewModel.crm.hubspotActiveAuthMode],
    ["HubSpot requested auth", viewModel.crm.hubspotRequestedAuthMode],
    ["HubSpot token source", viewModel.crm.hubspotTokenSource],
    ["Static token enabled", viewModel.crm.hubspotStaticTokenEnabled],
    ["Browser secrets exposed", viewModel.crm.hubspotBrowserSecretsExposed],
    ["HubSpot non-boot-critical", viewModel.crm.hubspotNonBootCritical],
    ...
    ["Association status", viewModel.crm.associationStatus],
    ["Association source", viewModel.crm.associationSource],
    ["Association project", viewModel.crm.associationProjectId],
    ["Association contact", viewModel.crm.associationContactId],
    ["Association company", viewModel.crm.associationCompanyId],
    ["Association deal", viewModel.crm.associationDealId],
    ["Association read only", viewModel.crm.associationReadOnly],
    ["Selector owns association", viewModel.crm.associationSelectorOwned],
    ["Provider mutation enabled", viewModel.crm.associationProviderMutationEnabled],
    ["Provider sync enabled", viewModel.crm.associationProviderSyncEnabled],
  ]);
