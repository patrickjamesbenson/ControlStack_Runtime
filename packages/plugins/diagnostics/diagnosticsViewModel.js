...
function emptyAuthority() {
  return {
    ...
    nvb: { matched: false, checked: false, confidence: "none", source: "none", recordId: null, reason: "Authority unavailable.", liveReadStatus: "live-read-unavailable", liveReadConfigured: false },
...
export function createDiagnosticsViewModel({ adapter, diagnosticsState }) {
  ...
  return {
    ...
    authority: {
      ...
      nvbLiveReadStatus: authority.nvb?.liveReadStatus || "live-read-unavailable",
      nvbLiveReadConfigured: stateLabel(authority.nvb?.liveReadConfigured),
      nvbNonBootCritical: stateLabel(authority.nvb?.nonBootCritical !== false),
      nvbTimeoutMs: authority.nvb?.timeoutMs || "none",
    ...
    crm: {
      ...
      hubspotConfigured: stateLabel(crm.hubspot?.configured),
      hubspotReadOnly: stateLabel(crm.hubspot?.readOnly !== false),
      hubspotReason: crm.hubspot?.reason || "none",
      hubspotAuthStatus: crm.hubspot?.auth?.status || "unknown",
      hubspotPrimaryAuthMode: crm.hubspot?.auth?.primaryAuthMode || "oauth-server-bearer",
      hubspotActiveAuthMode: crm.hubspot?.auth?.activeAuthMode || "unknown",
      hubspotRequestedAuthMode: crm.hubspot?.auth?.requestedAuthMode || "unknown",
      hubspotTokenSource: crm.hubspot?.auth?.tokenSource || "none",
      hubspotStaticTokenEnabled: stateLabel(crm.hubspot?.auth?.staticTokenMode?.enabled),
      hubspotBrowserSecretsExposed: stateLabel(crm.hubspot?.auth?.browserSecretsExposed),
      hubspotNonBootCritical: stateLabel(crm.hubspot?.auth?.nonBootCritical),
      ...
      associationStatus: crm.association?.status || "none",
      associationSource: crm.association?.source || "none",
      associationProjectId: crm.association?.projectId || "none",
      associationContactId: crm.association?.contact?.contactId || "none",
      associationCompanyId: crm.association?.company?.companyId || "none",
      associationDealId: crm.association?.deal?.dealId || "none",
      associationReadOnly: stateLabel(crm.association?.readOnly !== false),
      associationSelectorOwned: stateLabel(crm.association?.diagnostics?.selectorOwned),
      associationProviderMutationEnabled: stateLabel(crm.association?.diagnostics?.providerMutationEnabled),
      associationProviderSyncEnabled: stateLabel(crm.association?.diagnostics?.providerSyncEnabled),
    ...
    visibility: {
      ...
      liveReadStatus: visibility.authority?.liveReadStatus || authority.nvb?.liveReadStatus || "live-read-unavailable",
